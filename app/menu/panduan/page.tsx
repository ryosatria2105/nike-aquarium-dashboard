...
const LANGKAH_INPUT = [
  ...
  },
  {
    ...
    desc:
      "Total Uang Mesin diisi sesuai angka omzet di layar/struk mesin kasir — nominal ini yang jadi acuan omzet resmi. Total Tunai diisi sesuai hasil hitung fisik uang di laci. Kedua angka boleh berbeda, itu wajar, tapi tetap harus diisi apa adanya.",
  },
  {
    icon: Camera,
    label: "Langkah 3",
    ...
    desc:
      "Foto pertama wajib — ambil langsung dari kamera atau pilih dari galeri, pastikan angka di struk terbaca jelas. Foto kedua opsional, biasanya dipakai untuk bukti tambahan seperti struk tunai terpisah. Format yang didukung JPG, PNG, WEBP, maksimal 5MB per foto.",
  },
  {
    icon: Save,
    label: "Langkah 4",
...
const TIPS = [
  ...
  "Kalau salah input, tenang — laporan tetap bisa diedit kapan saja lewat halaman Riwayat.",
];
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-card bg-surface p-4 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-12px_rgba(0,0,0,0.12)]">
            ...
            <p className="mt-1 text-[12.5px] leading-relaxed text-muted">
              Untuk laporan kasir yang tutup di jam kerja pagi.
            </p>
          </div>
          <div className="rounded-card bg-surface p-4 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-12px_rgba(0,0,0,0.12)]">
            ...
            <p className="mt-1 text-[12.5px] leading-relaxed text-muted">
              Untuk laporan kasir yang tutup di jam kerja siang.
            </p>
          </div>
        </div>
      </section>
